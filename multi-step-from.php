...
<body>
        ...
        <form id="rvx-export-form">
            ...
            <div class="step step-3">
                <div class="form-group">
                    <input type="checkbox" name="select-all" id="rvx-select-all" onclick="toggle(this);" />
                    <label for="select-all"> Column </label> <br> <br>
                    <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
                    <label for="vehicle1" name="vehicle1"> I have a bike</label><br>
  ...
  const form = document.getElementById("rvx-export-form");  
  ...
  form.addEventListener("submit", (e) => {  
    e.preventDefault();  
    const inputs = [];  
    form.querySelectorAll("input[type='number'],input[type='checkbox']:checked, select").forEach((input) => {  
